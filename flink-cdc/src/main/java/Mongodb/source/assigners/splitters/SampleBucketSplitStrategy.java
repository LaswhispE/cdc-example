...
package Mongodb.source.assigners.splitters;

import Mongodb.source.dialect.MongoDBDialect;
import Mongodb.source.utils.ChunkUtils;
import Mongodb.source.utils.MongoUtils;
...
import static Mongodb.MongoDBEnvelope.*;
...
public class SampleBucketSplitStrategy implements SplitStrategy {
    ...
    public Collection<SnapshotSplit> split(SplitContext splitContext) {
        ...
        MongoCollection<BsonDocument> collection =
                MongoUtils.collectionFor(splitContext.getMongoClient(), collectionId, BsonDocument.class);
